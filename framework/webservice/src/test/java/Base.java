...
public abstract class Base extends AbstractTest {
	...
	protected String[] testDependencies() {
		return new String[]{
			...
			"org.daisy.pipeline:clientlib-java-jabx:?",
			"org.daisy.pipeline:webservice-jabx:?"
		};
	}
	
	@ProbeBuilder
	public TestProbeBuilder probeConfiguration(TestProbeBuilder probe) {
		probe.setHeader("Service-Component", "OSGI-INF/mock-module.xml,"
		                                   + "OSGI-INF/mock-script.xml,"
